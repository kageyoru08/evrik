...
Use a concise answer with citations near the claims they support. Add a source table or saved research note when the work will be continued, audited, or compared later. Preserve sufficient bibliographic details and brief evidence notes; copying complete papers or filling the context with raw search output is unnecessary.

When recommending an experiment, identify which uncertainty it would resolve and which literature finding motivates it. Follow [experiments.md](experiments.md) before execution. Follow [evidence.md](evidence.md) for final conclusions and reusable records.
